  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6 border border-gray-200 dark:border-gray-700">
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
        Select the primary region for storing your repository data, AI
      ...
      <div className="space-y-4">
        {["US", "EU", "APAC"].map((r) => (
          <label
            key={r}
            className="flex items-center p-3 border rounded-md cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 dark:border-gray-600"
          >
            <input
              type="radio"
              name="region"
