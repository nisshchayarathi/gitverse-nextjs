...
export function FirstPRSimulator({
  issue,
  repository,
  loading = false,
}: FirstPRSimulatorProps) {
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Preparing a guided first pull request plan for the selected issue.
          </CardDescription>
        </CardHeader>
    ...
    return (
      <Card>
        <CardHeader>
          <CardTitle>First PR Simulator</CardTitle>
          <CardDescription>
            Choose an issue to see a guided first PR breakdown.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <EmptyState
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>First PR Simulator</CardTitle>
        <CardDescription>
          Based on issue content and repository structure, this simulator
          predicts a focused starting point.
        </CardDescription>
      </CardHeader>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-lg border border-border p-4">
            ...
            <div className="text-xs text-muted-foreground mt-1">
              Estimated size: {simulation.changeSize}
            </div>
          </div>
          <div className="rounded-lg border border-border p-4">
            <div className="text-sm font-medium text-muted-foreground">
            ...
            <div className="text-xs text-muted-foreground mt-1">
              Estimated line changes: {simulation.estimatedLines}
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-2">
              {simulation.predictedFiles.length > 0 ? (
                ...
                <div className="rounded-lg border border-border p-4 text-sm text-muted-foreground">
                  No file predictions available. Examine repository structure to
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-lg border border-border p-4">
              ...
              <div className="text-sm font-semibold">
                {simulation.startingPoint.startHere}
              </div>
              <div className="mt-2 text-xs text-muted-foreground">
                {simulation.startingPoint.reason}
              </div>
            </div>
            <div className="rounded-lg border border-border p-4">
              <div className="mb-2 text-sm font-medium text-muted-foreground">
