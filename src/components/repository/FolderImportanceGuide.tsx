    ...
    <Card className="glass border border-border/70 transition-all duration-300">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="rounded-lg border border-amber-300/40 bg-amber-500/5 p-3 text-xs text-amber-700">
          ...
          <p className="mt-1">
            Critical areas (5 stars) require careful attention when making
            changes. Core modules (3-4 stars) are essential to application
            functionality. Supporting areas (1-2 stars) are helper utilities.
          </p>
        </div>
      </CardContent>
    </Card>
