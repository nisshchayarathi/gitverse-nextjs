      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
          <div>
            <h4 className="font-medium text-slate-200">
              Mandatory AI Security Review
            </h4>
            <p className="text-sm text-slate-400">
              Require all PRs to pass an AI security review before merging.
            </p>
          </div>
          <button
          ...
          >
            <div
              className={`w-4 h-4 bg-white rounded-full absolute top-1 transition-transform ${policies.enforceSecurityReviews ? "translate-x-7" : "translate-x-1"}`}
            />
          </button>
        </div>
        ...
        <div className="flex items-center justify-between p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
          <div>
            ...
            <p className="text-sm text-slate-400">
              Automatically scan for exposed secrets on all commits.
            </p>
          </div>
          <button
          ...
          >
            <div
              className={`w-4 h-4 bg-white rounded-full absolute top-1 transition-transform ${policies.enforceSecretScanning ? "translate-x-7" : "translate-x-1"}`}
            />
          </button>
        </div>
        ...
        <div className="flex items-center justify-between p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
          <div>
            ...
            <p className="text-sm text-slate-400">
              Prevent merging if high-severity secrets (like AWS keys) are
              detected.
            </p>
          </div>
          <button
          ...
          >
            <div
              className={`w-4 h-4 bg-white rounded-full absolute top-1 transition-transform ${policies.blockCriticalSecrets ? "translate-x-7" : "translate-x-1"}`}
            />
          </button>
        </div>
        ...
        <div className="flex items-center justify-between p-4 bg-amber-900/20 rounded-lg border border-amber-500/30">
          <div>
            <h4 className="font-medium text-amber-200">
              Policy Lock (Enforce Globally)
            </h4>
            <p className="text-sm text-amber-400/80">
              If enabled, repository maintainers cannot override or weaken these
              policies.
            </p>
          </div>
          <button
          ...
          >
            <div
              className={`w-4 h-4 bg-white rounded-full absolute top-1 transition-transform ${policies.policyLockEnabled ? "translate-x-7" : "translate-x-1"}`}
            />
          </button>
        </div>
      </div>
