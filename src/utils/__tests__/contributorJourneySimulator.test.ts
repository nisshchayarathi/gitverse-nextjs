...
describe("contributor journey simulator", () => {
  it("infers authentication category and ranks auth files highly", () => {
    const repository = {
      ...
      commits: [
        { hash: "abc123", message: "Fix auth provider flow", author: "test", date: new Date(), filesChanged: 1 },
        { hash: "def456", message: "Improve login session handling", author: "test", date: new Date(), filesChanged: 2 },
      ],
    };
